                ...
                <ContentWrapper>
                    ...
                    <Box>
                        ...
                        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree
                            ...
                            Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noreferrer">Privacy
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Mock N Roll, accessible from <a
                                    href="https://mocknroll.id" rel="external nofollow noopener noreferrer"
                                    target="_blank">https://mocknroll.id</a></p>
                            </li>
                            <li>
                        ...
                        <p>Usage Data may include information such as Your Device Internet Protocol address (e.g. IP
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or
                                    other equivalent forms of electronic communication, such as a mobile application
                        ...
                        <p>Your information, including Personal Data, is processed at the Company operating offices
                        ...
                        <p>If We need to rely on consent as a legal basis for processing Your information and Your
                            country requires consent from a parent, We may require Your parent consent before We
                        ...
                        <p>Our Service may contain links to other websites that are not operated by Us. If You click on
                            a third party link, You will be directed to that third party site. We strongly advise You
                        ...
                        <ul>
                            <li>By email: contact@hae.my.id</li>
                        </ul>
                    </Box>
                </ContentWrapper>
            </Layout>
